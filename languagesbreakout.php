...
?>  
   ...
   <?php
if ($lcclass == "") {
    $lcdisplay = '<h2>All Foreign Language Items by <a href="languages.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">LC Class</a> <a href="" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">By Language</a></h2>';
} elseif ((strlen($lcclass) > 1) and ($lcclass[1] == '[')) {
    $lcdisplay = '<h2>All Foreign Language Items <a href="" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">LC Class: ' . $lcclass[0] . "1 - " . $lcclass[0] . "9999</a></h2>";
} else {
    $lcdisplay = '<h2>All Foreign Language Items <a href="" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">LC Class: ' . $lcclass . '</a></h2>';
}
?> 
                        <h3><?php
echo $lcdisplay;
