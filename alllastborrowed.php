...
$sql = 'SELECT LEFT(lastborrowed,4)  as label, count(*) as value FROM ' . THIS_TABLE . ' WHERE lastborrowed is not null GROUP BY LEFT(lastborrowed,4)';
...
//set page title here
$pagetitle = "Number of Items by Last Checkout Date";
...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        <h2>Number of Items by Last Checkout Date</h2>
...
display_chart("Last Checkout Date");
 ?>
