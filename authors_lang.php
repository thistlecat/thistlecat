...
foreach ($groupxresults as $k4 => $v4) {
    if ($v4['value'] <> "") {
        $groupxresults[$k4]['link'] = "JavaScript:getresults('" . $k4 . "','eng','" . urlencode($thisstart) . "|" . $thisend . "')";
    }
}
...
foreach ($group0results as $k4 => $v4) {
    if ($v4['value'] <> "") {
        $group0results[$k4]['link'] = "JavaScript:getresults('" . $k4 . "','ger','" . $thisstart . "|" . $thisend . "')";
    }
}
...
foreach ($group1results as $k4 => $v4) {
    if ($v4['value'] <> "") {
        $group1results[$k4]['link'] = "JavaScript:getresults('" . $k4 . "','fre','" . $thisstart . "|" . $thisend . "')";
    }
}
//end getting group 1
...
foreach ($group2results as $k4 => $v4) {
    if ($v4['value'] <> "") {
        $group2results[$k4]['link'] = "JavaScript:getresults('" . $k4 . "','spa','" . $thisstart . "|" . $thisend . "')";
    }
}
//end getting group 2
...
foreach ($group3results as $k4 => $v4) {
    if ($v4['value'] <> "") {
        $group3results[$k4]['link'] = "JavaScript:getresults('" . $k4 . "','other','" . $thisstart . "|" . $thisend . "')";
    }
}
//end getting group 3
