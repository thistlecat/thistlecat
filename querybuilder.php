...
if (($k == 'language') and ($v <> '') ) {
if ($v == 'noneng') {$queryarray[] = ' language <> "eng" and language is not null';}
else {$queryarray[] = ' language = "' .  $v . '"';}
}
...
if ($logstatus == "loggedin"){
?>
<td><div style="display:none;"><?php echo $v2['status']; ?></div>
 <div class="radio">
  <label><input type="radio" name="<?php echo $v2['barcode']; ?>"<?php if ($v2['status'] == 'Keep'){echo " checked='checked'";} ?> value="Keep" />Keep</label>
</div>
<div class="radio">
  <label><input type="radio" name="<?php echo $v2['barcode']; ?>"<?php if ($v2['status'] == 'Weed'){echo " checked='checked'";} ?> value="Weed" />Weed</label>
</div>
<div class="radio">
  <label><input type="radio" name="<?php echo $v2['barcode']; ?>"<?php if ($v2['status'] == 'Check'){echo " checked='checked'";} ?> value="Check" />Check</label>
</div>
</td>
<?php
}
