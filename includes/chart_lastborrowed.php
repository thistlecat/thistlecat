...
$pointstr2 = "";
        ...
        datasets: [{
			...
			label: "Checked out before <?php echo $group0; ?>/Never checked out",
            backgroundColor: "<?php echo $color1; ?>",
            hoverBackgroundColor: "rgba(50,90,100,1)"
        },{
            data: [<?php echo $pointstr1; ?>],
			label: "Last checked out <?php echo $group0; ?>-<?php echo $group1; ?>",
            backgroundColor: "<?php echo $color2; ?>",
            hoverBackgroundColor: "rgba(140,85,100,1)"
        },{
            data: [<?php echo $pointstr2; ?>],
			label: "Last checked out since <?php echo ($group1+1) ?>",
...
$("#mainchart").click(function(e) {
   ...
   if(activeBars.length > 0){   
	...
	window.location.href="lastborrowedbreakout.php?lcclass=" + curlabel;
	}
	else if ((window.location.href).indexOf('lastborrowed.php') > -1) {
	window.location.href="subclass_lastborrowed.php?lcclass=" + curlabel;
	}
	else if ((window.location.href).indexOf('barcodes_lastborrowed') > -1) {
	return;
	}
	else if ((window.location.href).indexOf('authors_lastborrowed') > -1) {
