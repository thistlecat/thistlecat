  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>ThistleCAT assists in analyzing Preston Library's collection by providing data based on various paramaters including copyright date, total checkouts, last checkout date, and state and national holdings.</p>
        <p>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <h2>About this Tool</h2>
          ...
          <li>Total circulation history covers 1991 to present.</li>
          <li>Last checkout date covers 2003 to 2015.</li>
          <li>Holdings data is current as of Jan 4, 2016.</li>
          </ul>
          </p>
          <br />
...
?>
   ...
   <input  class="form-control input-sm" type="text" size="20" name="itemcallnumber" placeholde="Call number" /></div>
    <br />
            
        
Copyright Date<br />
    <div class="form-inline"><select  class="form-control input-sm" name="datefmt" >
       <option value="before">Before</option>
    <option value="after">After</option>
      <option value="equal">Equal to</option>
      </select>
   <input  class="form-control input-sm" type="text" size="10" name="copyrightdate" placeholder="YYYY" /></div>
    <br />
        
   Total Checkouts<br />
    <div class="form-inline"><select  class="form-control input-sm"  name="checkoutfmt"  >
       <option value="less">Fewer than</option>
    <option value="greater">Greater than</option>
      <option value="equal">Equal to</option>
      </select>
   <input  class="form-control input-sm" type="text" size="5" name="issues" /></div>
      
        <br />
         Last Checkout Date<br />
    <div class="form-inline"><select  class="form-control input-sm"  name="lastdatefmt" >
    <option value="before">Before</option>
   <option value="after">After</option>
      <option value="equal">Equal to</option></select>
   <input  class="form-control input-sm" type="text" size="10" placeholder="YYYY" name="lastborrowed" /></div>
...
<BR />
  ...
  <span class="label label-warning">  Percentage of Class to Weed</span><i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" title="Enter a value here to determine the best cutoff date if you only want to weed a certain percentage of the specified call number range."></i><br />
    <div class="form-inline">
   <input  class="form-control input" type="text" size="20" name="percent" placeholder="Enter number only" /></div>
   <BR />
  <button type="submit" class="btn btn-primary">Search</button>
        ...
        <div class="col-md-4">
         ...
         <br /><p>Get data for an individual item, including:
          <ul>
          <li>Total checkouts</li>
          <li>Last checkout date (2003 or later)</li>
          <li>Possible duplicates</li>
          <li>Holdings in Virginia and U.S. libraries</li>
          </ul>
          </p>
          <br />
          <br />
