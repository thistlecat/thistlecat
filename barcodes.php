...
include "includes/dbconnect.php";
	...
	$sql5 = 'SELECT title,author,itemcallnumber,cn_sort,issues,copyrightdate,barcode,oclc,biblionumber,lastborrowed,viva,duplicates,language FROM ' . THIS_TABLE . ' WHERE ' . $barcodequery . ' ORDER BY cn_sort ASC';
